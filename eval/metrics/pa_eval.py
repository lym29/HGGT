"""Borrowed from POEM-v2 ``lib/metrics/pa_eval.py`` (evaluation-only subset)."""
...
from ._logger import logger  # noqa: F401  (kept for API parity; unused here)
...
class PAEval(Metric):
    ...
    def feed(self, pred_joints_3d_abs, joints_3d_abs, pred_verts_3d_abs=None, verts_3d_abs=None, **kwargs):
        ...
        # scipy does not support batch operation
