...
from hggt.dependency.distortion import apply_distortion, iterative_undistortion, single_undistortion
...
def axis_angle_to_matrix(axis_angle: torch.Tensor) -> torch.Tensor:
    """
    modified from https://pytorch3d.readthedocs.io/en/latest/_modules/pytorch3d/transforms/rotation_conversions.html#axis_angle_to_matrix
